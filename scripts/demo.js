...
// Demo contract address (placeholder for demo purposes)
...
async function demonstrateDeployment() {
  ...
  console.log(`📍 Demo Address: ${DEMO_CONTRACT_ADDRESS}`);
  console.log(`🔗 Explorer: ${MASCHAIN_CONFIG.explorerUrl}/address/${DEMO_CONTRACT_ADDRESS}`);
